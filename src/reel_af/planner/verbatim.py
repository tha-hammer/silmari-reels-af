...
def _planner_candidate(
    ...
    return PlannerCandidate(
        ...
        source_window_index=candidate.source_window_index,
        source_window_start_s=candidate.source_window_start_s,
        source_window_end_s=candidate.source_window_end_s,
        ...
        CandidateSpan.model_validate(
            {
                ...
                "source_window_id": _raw_value(raw_candidate, "source_window_id", None),
                "source_window_index": _raw_value(raw_candidate, "source_window_index", None),
                "source_window_start_s": _raw_value(raw_candidate, "source_window_start_s", None),
                "source_window_end_s": _raw_value(raw_candidate, "source_window_end_s", None),
